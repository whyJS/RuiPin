			...
			$(".prev").click(function(){
				...
				$(".room").css("background-image","url(../images/sdjz"+index+".jpg)");
			});
			//下一页
			$(".next").click(function(){
				index++;
				...
				$(".round").click(function(){
					index=1;
				$(".room").css("background-image","url(../images/sdjz1.jpg)");
			...
			$(".round1").click(function(){
				index=2;
				$(".room").css("background-image","url(../images/sdjz2.jpg)");
			...
			$(".round2").click(function(){
				index=3;
				$(".room").css("background-image","url(../images/sdjz3.jpg)");
				$(".round").css("background-color","");
				$(".round1").css("background-color","");
